...
/**
 * Imports the player mesh into the scene adding movment with it 
 *
...
/**
 * Creates a goal post in the scene so more than one can be added without extra code.
 *
 * @param {Scene} scene - The scene to create the goal post in.
 * @param {Vector3} position - The position of the goal post.
 * @return {Mesh} The created goal post mesh.
 */
...
/**
 * Creates a goal volume mesh in the scene. this allows the ball to pass through an object and give score 
 *
...
/**
 * Creates and configures an action manager for the given scene. make player move 
 *
 ...
 *
 * @param {Scene} scene - The scene to create the sphere in.
 * @param {number} x - The x coordinate.
 * @param {number} y - The y coordinate.
 * @param {number} z - The z coordinate.
 * @param {number} scale - The scale of the sphere.
...
/**
 * Creates a ground in the scene.
 *
 * @param {Scene} scene - The scene to create the ground in.
 * @param {number} size - The size of the ground.
 * @param {number} width - The width of the ground.
 * @param {number} rotationAngle - The rotation angle of the ground.
 * @return {Mesh} The created ground mesh.
 */
...
/**
 * Creates a skybox in the scene.
 *
 * @param {Scene} scene - The scene to create the skybox in.
 * @return {Mesh} The created skybox mesh.
 */
  function createSkybox(scene: Scene) {
    ...
    /**
   * Creates a fence in the scene. not adding all 4 but there is 4 for collision reasons
   *
  ...
  /**
 * Creates a light in the scene based on the specified parameters.
 *
 * @param {Scene} scene - The scene to create the light in.
 * @param {number} index - The index representing the type of light.
 * @param {number} px - The x coordinate of the light's position.
 * @param {number} py - The y coordinate of the light's position.
 * @param {number} pz - The z coordinate of the light's position.
 * @param {number} colX - The red component of the light's color.
 * @param {number} colY - The green component of the light's color.
 * @param {number} colZ - The blue component of the light's color.
 * @param {Mesh} mesh - The mesh associated with the light.
 * @return {Light} The created light.
 */
  ...
  /**
 * Creates a hemispheric light in the scene.
 *
 * @param {Scene} scene - The scene to create the hemispheric light in.
 * @return {HemisphericLight} The created hemispheric light.
 */
  ...
  /**
 * Creates scoring elements in the scene.
 *
 * @param {Scene} scene - The scene to create scoring elements in.
 */
  ...
  /**
 * Creates a reset button in the scene.
 *
 * @param {Scene} scene - The scene to create the reset button , this will bring you back to the main menu.
 */
